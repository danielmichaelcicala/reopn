...
\Daniel{ Outline
  \begin{enumerate}
  \item Strucutred cospas and their morphisms form a topos
  \item Structured cospans and their rewrites form a double category
  \end{enumerate}
  The first is a new result here and the section comes from
  my work with Kenny.
}
...
\begin{definition}
  ...
  limits (that is, a geometric morphism). An \df{$ L $-structured
