...
\begin{definition}
  ...
  \item the horizontal arrows $ a \horarrow b $ are cospans
    $ \csp{La}{x}{Lb} $, and
...
Actually, $ \SSStrCsp_L $ is a symmetric monoidal double category. Since all involved categories are topoi, we can lift
